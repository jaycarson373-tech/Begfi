  ...
  return {
    ...
    metrics: [
      ...
      },
      {
        ...
        helper: "Views from verified workers' profile-scanned $POW posts.",
        tone: "lime",
      },
      {
        key: "current-round",
        ...
        helper: "Workers qualify by linking X to a wallet with 1M+ $POW.",
        tone: "steel",
      },
    ],
    ...
    totals: [
      ...
      },
      {
        ...
        helper: "Profile posts, engagement, current holdings, hold time, and volume-score totals.",
        tone: "steel",
      },
    ],
  };
