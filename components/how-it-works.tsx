...
const steps = [
  ...
  "The automatic scanner verifies wallet activity and registers the account as a worker.",
  "Keep posting with the $POW cashtag while the profile scanner scores real outreach and engagement.",
